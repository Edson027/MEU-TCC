...
@section('title', 'Novo Pedido de Medicamento')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-clipboard-list"></i> Novo Pedido de Medicamento
        </h1>
                            ...
                            <select class="form-control" id="medicine_id" name="medicine_id" required>
                                ...
                                @foreach($medicines as $medicine)
                                    <option value="{{ $medicine->id }}" 
                                        ...
                                        @if(old('medicine_id') == $medicine->id) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="urgency_level" name="urgency_level" required>
                                @foreach($urgencyLevels as $value => $label)
                                    <option value="{{ $value }}" 
                                        @if(old('urgency_level', 'medium') == $value) selected @endif>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Disparar evento change se já houver um medicamento selecionado (em caso de erro no formulário)
